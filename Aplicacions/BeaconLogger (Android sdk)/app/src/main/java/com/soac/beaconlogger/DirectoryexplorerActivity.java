...
public class DirectoryexplorerActivity extends ActionBarActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        File f = new File(Environment.getExternalStorageDirectory() + "/DATASET_BEACONS_WITH_ANDROID_SDK/");
        files = f.listFiles();

        //Mostramos la ruta en el layout
        TextView ruta = (TextView) findViewById(R.id.textView_root);
        ruta.setText(Environment.getExternalStorageDirectory() + "/DATASET_BEACONS_WITH_ANDROID_SDK/");
        ...
        lstOpciones.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> a, View v, final int position,   long id) {
                ...
                PopupMenu popup = new PopupMenu(DirectoryexplorerActivity.this,v);
