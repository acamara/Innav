...
import com.kontakt.sample.util.myLogger;
...
public class BeaconRangeActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logger = new myLogger(this,max_num_samples);
...
*/
        ...
        if(address != null && !address.equals("All")) {
        ...
        if(address.equals("All")) {
            Log.d("Albert - DEBUG", "No Filtrant per adreça cap Beacon");
                ...
                BeaconRangeActivity.this.runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if(!logger.all_samples_captured()) {
                            ...
                            textView_counter.setText("Capturing data...");
                        }
                        else {
