...
accuracy_rectified_all_beacons_over_distance <- function(path, beacon_name, txPower){
  ...
  accuracy_data <- lapply(rssi_data, calculate_Accuracy_kontakt, txPower)
...
promedio_accuracy_1 <- accuracy_rectified_all_beacons_over_distance(path, "D0:F8:F2:95:3A:5C", -77)

path <- "./DATASET_BEACONS/beacon_D640866DBDDF/hall_3/"
promedio_accuracy_2 <- accuracy_rectified_all_beacons_over_distance(path, "D6:40:86:6D:BD:DF", -77)

path <- "./DATASET_BEACONS/beacon_D9A3286AA7F1/hall_3/"
promedio_accuracy_3 <- accuracy_rectified_all_beacons_over_distance(path, "D9:A3:28:6A:A7:F1", -77)

path <- "./DATASET_BEACONS/beacon_F57AA5E3EF18/hall_3/"
promedio_accuracy_4 <- accuracy_rectified_all_beacons_over_distance(path, "F5:7A:A5:E3:EF:18", -77)

path <- "./DATASET_BEACONS/beacon_FFA67CAFB0CB/hall_3/"
promedio_accuracy_5 <- accuracy_rectified_all_beacons_over_distance(path, "FF:A6:7C:AF:B0:CB", -77)
