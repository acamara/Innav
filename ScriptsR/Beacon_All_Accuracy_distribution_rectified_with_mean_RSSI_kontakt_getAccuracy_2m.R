...
boxplot(accuracy_data,main="Accuracy at 2 meters",xlab="BEACON",ylab="Distance [m]",
...
boxplot(accuracy_data,main="Accuracy at 2 meters rectified with RSSI mean and kontakt getAccuracy",xlab="BEACON",ylab="Distance [m]",
        names=c(paste(address_data[[1]][[1]]),paste(address_data[[2]][[1]]),paste(address_data[[3]][[1]]),paste(address_data[[4]][[1]]),paste(address_data[[5]][[1]])),
        ylim=c(0,7), las=1)
