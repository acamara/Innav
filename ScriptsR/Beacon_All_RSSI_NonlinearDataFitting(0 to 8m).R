...
path <- "./DATASET_BEACONS/calibration/beacon_D0F8F2953A5C/"
data_fiting(path, distances, "Beacon D0:F8:F2:95:3A:5C")

path <- "./DATASET_BEACONS/calibration/beacon_D9A3286AA7F1/"
data_fiting(path, distances, "Beacon D9:A3:28:6A:A7:F1")

path <- "./DATASET_BEACONS/calibration/beacon_D640866DBDDF/"
data_fiting(path, distances, "Beacon D6:40:86:6D:BD:DF")

path <- "./DATASET_BEACONS/calibration/beacon_F57AA5E3EF18/"
data_fiting(path, distances, "Beacon F5:7A:A5:E3:EF:18")

path <- "./DATASET_BEACONS/calibration/beacon_FFA67CAFB0CB/"
