...
boxplot_rssi_all_beacons_specific_distance_grouping(path, 0, -40, 5)
...
boxplot_rssi_all_beacons_specific_distance_grouping(path, 6, -92.56, 5)

path <- "./DATASET_BEACONS/measures_at_seven_meter/d1/"

boxplot_rssi_all_beacons_specific_distance_grouping(path, 7, -93.90, 5)
path <- "./DATASET_BEACONS/measures_at_eight_meter/d1/"

boxplot_rssi_all_beacons_specific_distance_grouping(path, 8, -95.06, 5)