# Beacon_D9A3286AA7F1_RSSI_NonlinearDataFitting__(0.50 to 8.5m)
...
# look at it
plot(xdata, ydata, main="Mean RSSI Distribution over Distance - Beacon D9:A3:28:6A:A7:F1", xlab="Distance [meters]", ylab="RSSI [dBm]", las=1, xaxt="n")
