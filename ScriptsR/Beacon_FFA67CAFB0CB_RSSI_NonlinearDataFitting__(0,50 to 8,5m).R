# Beacon_FFA67CAFB0CB_RSSI_NonlinearDataFitting__(0.50 to 8.5m)
...
path <- "./DATASET_BEACONS/beacon_FFA67CAFB0CB/hall_2/"
...
# look at it
plot(xdata, ydata, main="Mean RSSI Distribution over Distance - Beacon FF:A6:7C:AF:B0:CB", xlab="Distance [meters]", ylab="RSSI [dBm]", las=1, xaxt="n")
