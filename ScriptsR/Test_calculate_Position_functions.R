...
source('./ScriptsR/calculate_Position_ IntersectionsCircumferences.R');
calculate_Position_IntersectionsCircumferences(b1x, b1y, b2x, b2y, b3x, b3y, r1, r2, r3)

source('./ScriptsR/calculate_Position_Centroid.R');
calculate_Position_Centroid(b1x, b1y, b2x, b2y, b3x, b3y)