...
plot(0, 0, type="n", main="Test environment - Room 1 (with real distances and LSQ method)", xlab="x (6.00 m)", ylab="y (4.40 m)", xlim=c(0,ceiling(roomWidth)), ylim=c(0,ceiling(roomHeight)), xaxt="n", yaxt="n")
